...
#' @param task see [get_performance()]
#' @param k_foldcv see [get_performance()]
#' @param model_param see [get_performance()]
#' @param performance_metric see [get_performance()]
#'
...
#' myreps <- adaptive_nreps(instance   = instance,
...
adaptive_nreps <- function(instance,            # instance parameters
                       ...
                       task, k_foldcv, model_param, performance_metric # inputs for get_performance
                       )
{
  ...
  for (algo in algorithms) {
    newX[[algo]] <- get_performance(
      data = instance$Data, task = task,
      k_foldcv = k_foldcv,
      model_name = algo,
